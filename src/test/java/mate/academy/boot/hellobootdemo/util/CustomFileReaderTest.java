...
public class CustomFileReaderTest {
    ...
    public void shouldExecute_OK() {
        ...
        Assert.assertEquals(actual.get(0), EXPECTED_HEADER);
        Assert.assertEquals(actual.get(1), EXPECTED_FIRST_ROW);
        Assert.assertEquals(actual.get(2), EXPECTED_SECOND_ROW);
    }
}
