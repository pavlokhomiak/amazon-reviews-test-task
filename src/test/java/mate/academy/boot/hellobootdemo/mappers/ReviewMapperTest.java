...
public class ReviewMapperTest {
    ...
    private ReviewDto normalDto = new ReviewDto(Long.parseLong("38"), "B001EO5QW8",
            "A3MGP2E1ZZ6GRB", "\"Zardoz \"\"focuspuller\"\"\"", Integer.parseInt("1"),
            Integer.parseInt("1"), Integer.parseInt("5"), Long.parseLong("1238457600"),
            "it's oatmeal", "\"What else do you need to know? Oatmeal, instant (make it with a half"
            + " cup of low-fat milk and add raisins\tnuke for 90 seconds). More expensive than "
            + "something. It's still just oatmeal. Mmm, convenient!\"");
    private ReviewDto reviewWithNullField = new ReviewDto(Long.parseLong("38"), "B001EO5QW8",
            "A3MGP2E1ZZ6GRB", "\"Zardoz \"\"focuspuller\"\"\"", Integer.parseInt("1"),
            Integer.parseInt("1"), Integer.parseInt("5"), null, "it's oatmeal",
            "\"What else do you need to know? Oatmeal, instant (make it with a half cup of low-fat"
                    + " milk and add raisins\tnuke for 90 seconds). More expensive than something."
    ...
    public static void inject() {
        ...
        expectedReview.setTime(LocalDateTime.ofEpochSecond(1238457600L, 0,
                ZoneOffset.UTC));
        expectedReview.setSummary("it's oatmeal");
        expectedReview.setText("\"What else do you need to know? Oatmeal, instant (make it with a "
                + "half cup of low-fat milk and add raisins\tnuke for 90 seconds). More expensive"
                + " than something. It's still just oatmeal. Mmm, convenient!\"");
    }
